...
typedef enum MenuCommand {
    ...
    MENU_INHERIT, MENU_GLOBAL_DEFAULTS, MENU_BINDINGS, MENU_CRT, MENU_NAMETABLES, MENU_APU_VIEWER,
    MENU_REGION_AUTO, MENU_REGION_NTSC, MENU_REGION_PAL, MENU_REGION_DENDY
} MenuCommand;
